...
class MCQRequest(BaseModel):
    question: str = Field(description="The original question to generate variations for.")
    options: List[str] = Field(description="The list of options for the question.")
    answer_index: int = Field(description="The index of the correct answer in the options list.")

# Define the structure for each MCQ variation
class MCQQuestion(BaseModel):
    question: str = Field(description="The variation of the original question.")
    options: List[str] = Field(description="The list of options for the variation.")
    answer_index: int = Field(description="The index of the correct answer in the options list.")

# Define the response model
class MCQVariation(BaseModel):
    variations: List[MCQQuestion] = Field(description="List of generated MCQ variations.")
...
prompt_template = PromptTemplate.from_template(template=MCQ_VARIATION_GENERATOR_PROMPT)
